...
# If the computer_score is over 21, then the computer loses. If none of the above, then the player with
...
my_email = "jracantel@gmail.com"
password = "Jra*1974*cantel()"
connection = smtplib.SMTP("smtp.gmail.com")
connection.starttls()
connection.login(user=my_email, password=password)
connection.sendmail(from_addr=my_email, to_addrs="rubielaaguirreder@gmail.com", msg="Hello")
connection.close()
'''
import random as rn
def deal_car():
...
def play_game():
    ...
    while not is_game_over:
        ...
        if user_score == 0 or user_score > 21:
            ...
            user_should_deal = input('otra carta y or n')
            if user_should_deal == 'y':
                user_cards.append(deal_car())
...
computer_score = calculate_score(c_c)
user_score = calculate_score(c_u)
print(c_c, calculate_score(c_c))
print(c_u, calculate_score(c_u))
print(compare(user_score, computer_score))'''
#print(deal_car())